...
import com.example.myblog.common.modules.common.validator.Create;
import com.example.myblog.common.modules.common.validator.FieldRepeatValidator;
...
//	@FieldRepeatValidator(className = "com.duo.tao.modules.system.entity.User", field = "pwd", message = "密码重复！")
//	@FieldRepeatValidator(className = "com.duo.tao.modules.system.entity.User", field = "pwd", message = "密码重复！",groups={FieldRepeatValidator.class})
	private String pwd;
    /**
     * 昵称
     */
