package com.example.myblog.common.redis;
...
import com.example.myblog.common.utils.CollectionUtil;
import com.example.myblog.common.utils.JSONUtils;
...
public class CacheAspect {
    ...
    public void handleCacheDelete(JoinPoint pjp, RedisCacheDelete anno) {
        ...
        Set<String> keys = CollectionUtil.mergeSet(redisTemplate.keys(key), redisTemplate.keys(key + ":*"));
