...
public class CollectionUtils {
    ...
    public static <T> Set<T> mergeSet(Set<T> set1, Set<T> set2) {
        ...
        if (!DataUtils.isNullOrEmpty(set1)) set.addAll(set1);
        if (!DataUtils.isNullOrEmpty(set2)) set.addAll(set2);
        return set;
    }
    ...
    public static <T> List<T> mergeList(List<T> list1, List<T> list2) {
        ...
        if (!DataUtils.isNullOrEmpty(list1)) list.addAll(list1);
        if (!DataUtils.isNullOrEmpty(list2)) list.addAll(list2);
        return list;
    }
    ...
    public static String[] removeNull(String[] array) {
        List<String> list = Arrays.stream(array).filter(s -> !DataUtils.isNullOrEmpty(s)).collect(Collectors.toList());
    ...
    public static List<String> stringToList(String str) {
        if (DataUtils.isNullOrEmpty(str)) return new ArrayList<>();
