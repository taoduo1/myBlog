package com.td.myblog.myblog.common.config.redis;


import com.alibaba.druid.support.json.JSONUtils;
import com.google.common.collect.Maps;
import com.td.myblog.myblog.common.config.redis.annotation.RedisCacheDelete;
import com.td.myblog.myblog.common.config.redis.annotation.RedisCacheGet;
import com.td.myblog.myblog.common.config.redis.annotation.RedisCachePut;
import com.td.myblog.myblog.common.utils.CollectionUtils;
import com.td.myblog.myblog.common.utils.JSONUtil;
...
public class CacheAspect {
    ...
    public Object handleCacheGet(ProceedingJoinPoint pjp, RedisCacheGet anno) throws Throwable {
        ...
        if (json != null) {
            LOGGER.info("缓存获得 key={}", key); // TODO 调试信息，待删除
            Type returnType = method.getGenericReturnType();
            result = JSONUtil.fromJSONString(json, returnType);
            //
            return result;
        }
    ...
    public void handleCacheDelete(JoinPoint pjp, RedisCacheDelete anno) {
        LOGGER.info("缓存删除 {}", anno.key());
        // 解析key
        String key = genKey(anno.key(), pjp.getArgs());
        LOGGER.debug("缓存删除 key={}", key);
